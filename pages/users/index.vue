<template>
  <crud-list
    :columns="{id: 'ID', email: 'E-mail', firstname: 'Prénom', lastname: 'Nom'}"
    :data="data"
...
export default {
  ...
  mixins: [
    titleMixin('Utilisateurs'),
    searchFilterMixin(),
    updateListMixin(USERS, { mask: DEFAULT_MASK }),
    deleteInListMixin(USERS, { confirmation: 'Voulez vous vraiment supprimer cet utilisateur ?' }),
    importCSVMixin(USERS),
