...
const PHONE_MODELS = 'phoneModels';
...
export default {
  ...
  mixins: [
    titleMixin('Modèles de téléphones'),
    searchFilterMixin(),
    updateListMixin(PHONE_MODELS, { mask: DEFAULT_MASK }),
    deleteInListMixin(PHONE_MODELS, { confirmation: 'Voulez vous vraiment supprimer ce modèle de téléphone ?' }),
    importCSVMixin(PHONE_MODELS),
    exportCSVMixin(PHONE_MODELS, { mask: DEFAULT_MASK }),
  ],
};
</script>
